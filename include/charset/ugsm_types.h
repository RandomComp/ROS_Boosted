#ifndef _RANDOM_OS_UGSM_TYPES_H
#define _RANDOM_OS_UGSM_TYPES_H

#include "core/types.h"

#define UGSM_MAX_SIZE 1024

#define UGSM_MAX_LOADABLE_SIZE 128

#define UGSM_GLYPH_WIDTH 8

#define UGSM_GLYPH_HEIGHT 16

typedef uint8 UGSM_Glyph[UGSM_GLYPH_HEIGHT]; // width, height - 8, 16

typedef uint8 UGSM_Font[UGSM_MAX_LOADABLE_SIZE][UGSM_GLYPH_HEIGHT];

typedef enum UGSM_Codes {
    UGSM_CHAR_NULL,                 // \0
