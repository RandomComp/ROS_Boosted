...
// TODO: использовать в наборах байтах для инструкий завершающий байт 0xde

// TODO: Сделать возможным использования int ah или подобных через динамическое модификации опкодов

byte instructionsBaseBytes[][1] = {
	[RMAL_INSTRUCTION_NOP] = { 0x90, 0xde },
};
